...
allowed_fields = {
    ...
    "(AOP047)Short-term trade receivables": ["Short-term trade receivables", "Receivables from buyer", "Trade debtor" , "Trade receivables","Trade receivables - domestic","Trade receivables - foreign"],
